...
// 2. 위젯을 ConsumerWidget으로 만들면 Provider에 접근 할 수 있습니다.
class FruitPage extends ConsumerWidget {
  const FruitPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // 4. ref를 통해 Provider가 관리하는 상태(데이터)에 접근 할 수 있습니다.
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                // 7. ref.read() 메서드로 상태값이 아닌 FruitStore(창고)에 접근 할 수 있다.
...
// 3. ConsumerWidget 클래스의 build메서드는 WidgetRef를 참조 할 수 있습니다.
